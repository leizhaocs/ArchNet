...
DataType im2col_get_pixel(DataType *im, int input_h, int input_w, int h, int w, int c, int padding_h, int padding_w)
{
    h -= padding_h;
    w -= padding_w;
...
void col2im_add_pixel(DataType *im, int input_h, int input_w, int h, int w, int c, int padding_h, int padding_w, DataType val)
{
    h -= padding_h;
    w -= padding_w;
