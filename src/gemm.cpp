...
void gemm_nn(int M, int N, int K, DataType *A, int lda, DataType *B, int ldb, DataType *C, int ldc)
{
...
void gemm_nt(int M, int N, int K, DataType *A, int lda, DataType *B, int ldb, DataType *C, int ldc)
{
    #pragma omp parallel for
    for (int i = 0; i < M; i++)
    {
...
void gemm_tn(int M, int N, int K, DataType *A, int lda, DataType *B, int ldb, DataType *C, int ldc)
{
    #pragma omp parallel for
    for (int i = 0; i < M; i++)
    {
...
void gemm_tt(int M, int N, int K, DataType *A, int lda, DataType *B, int ldb, DataType *C, int ldc)
{
    #pragma omp parallel for
    for (int i = 0; i < M; i++)
    {
